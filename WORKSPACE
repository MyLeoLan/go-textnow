...
k8s_defaults(
    name = "k8s_deploy",
    cluster = "gke_starlit-primacy-254522_us-central1-a_standard-cluster-1",
    context = "gke_starlit-primacy-254522_us-central1-a_standard-cluster-1",
    image_chroot = "us.gcr.io/starlit-primacy-254522",
    kind = "deployment",
)

######### Dependencies added by Gazelle #########
go_repository(
...
go_repository(
    ...
    sum = "h1:LW+Hleh2O6GhtCrxk7FAZKs1IieJH6eXE7w3zrahh2k=",
    version = "v0.0.0-20190911072250-96a015d3fb1a",
)
